...
Original file is located at
    https://colab.research.google.com/drive/1VfY3DnybK1fwIRs0iiJoTLc3TuESFOGD
"""
...
def calidad_datos(df):
    ...
    for col in columnas_numericas:
        ...
        porcentaje_outliers[col] = 100 * n_outliers / df[col].count()

    resumen['outliers'] = resumen.index.to_series().map(outliers).fillna(0).astype(int)
    resumen['porcentaje_outliers'] = resumen.index.to_series().map(porcentaje_outliers).fillna(0.0)
    ...
    # Asegura orden por porcentaje de nulos
