...
Permite visualizar el impacto histórico de consolas como PS2, Wii, DS, PS3, X360, etc.
...
Otros: Sega, THQ, Konami, Sony Computer Entertainment, etc.
...
Tamaño de cada bloque = global_sales (millones de copias).
Este gráfico permite ver de forma intuitiva:
